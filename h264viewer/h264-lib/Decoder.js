...
(function (root, factory) {
    ...
    var getModule = function (par_broadwayOnHeadersDecoded, par_broadwayOnPictureDecoded) {
        ...
        var wasmImports = {
            "g": _broadwayOnHeadersDecoded,
            "f": _broadwayOnPictureDecoded,
        ...
        var ___wasm_call_ctors = function() {
            return (___wasm_call_ctors = Module["asm"]["i"]).apply(null, arguments)
        };
        var _broadwayCreateStream = Module["_broadwayCreateStream"] = function() {
            return (_broadwayCreateStream = Module["_broadwayCreateStream"] = Module["asm"]["j"]).apply(null, arguments)
        };
        var _broadwayPlayStream = Module["_broadwayPlayStream"] = function() {
            return (_broadwayPlayStream = Module["_broadwayPlayStream"] = Module["asm"]["k"]).apply(null, arguments)
        };
        var _broadwayInit = Module["_broadwayInit"] = function() {
            return (_broadwayInit = Module["_broadwayInit"] = Module["asm"]["l"]).apply(null, arguments)
        };
        var _broadwayExit = Module["_broadwayExit"] = function() {
            return (_broadwayExit = Module["_broadwayExit"] = Module["asm"]["m"]).apply(null, arguments)
        };
        var _broadwayGetMajorVersion = Module["_broadwayGetMajorVersion"] = function() {
            return (_broadwayGetMajorVersion = Module["_broadwayGetMajorVersion"] = Module["asm"]["n"]).apply(null, arguments)
        };
        var _broadwayGetMinorVersion = Module["_broadwayGetMinorVersion"] = function() {
            return (_broadwayGetMinorVersion = Module["_broadwayGetMinorVersion"] = Module["asm"]["o"]).apply(null, arguments)
        };
